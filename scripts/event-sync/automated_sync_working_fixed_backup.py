...
def main():
    ...
    # Summary by venue
    willspub_submitted = sum(1 for e in new_events[:submitted] if e.get('venue') == "Will's Pub")
    conduit_submitted = sum(1 for e in new_events[:submitted] if e.get('venue') == 'Conduit')
