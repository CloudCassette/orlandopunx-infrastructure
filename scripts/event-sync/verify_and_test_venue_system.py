...
def test_venue_enforcer():
    ...
    try:
        ...
        for i, event in enumerate(test_events, 1):
            ...
            print(
                f"   {i}. '{event['title']}' → {venue_info['name']} (ID: {venue_info['id']})"
            )
...
def main():
    ...
    print(
        "   4. Test with: python3 automated_sync_working_fixed_with_venue_enforcement.py"
    )
