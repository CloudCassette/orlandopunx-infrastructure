...
class GenericGancioSync:
    ...
    def convert_to_timestamp(self, event):
        ...
        try:
            start_datetime = datetime.strptime(f"{event['date']} {event['time']}", "%Y-%m-%d %H:%M")
    ...
    def submit_event(self, event):
        ...
        gancio_event = {
            ...
            "tags": ["conduit", "live-music", "orlando"] if event['source'] == 'conduit' else [event['source'], "live-music", "orlando"],
            "placeId": place_id,
            "multidate": False
        }
    ...
    def sync_events_from_file(self, filename):
        ...
        try:
            ...
            if submitted > 0:
                print(f"\n📋 Next steps:")
                print(f"   1. Go to your Gancio admin panel at https://orlandopunx.com/admin")
