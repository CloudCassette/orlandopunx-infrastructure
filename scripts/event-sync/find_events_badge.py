        ...
        for selector in badge_selectors:
            try:
                ...
                for element in elements:
                    ...
                    if "events" in text.lower() and (
                        "849" in text or any(char.isdigit() for char in text)
                    ):
            ...
            for element in all_elements:
                try:
                    ...
                    if text and ("events" in text.lower() or "849" in text):
                        ...
                        if "events" in text.lower() and any(
        ...
        if events_element:
            ...
            try:
                ...
                cards = driver.find_elements(
                    By.CSS_SELECTOR, ".card, .item, .list-item, .event-item"
                )
                if cards:
                ...
                content_divs = [
                    div
                    for div in divs
                    if len(div.text.strip()) > 20 and len(div.text.strip()) < 300
                ]
