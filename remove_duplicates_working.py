...
def navigate_to_events_page(driver, timeout=20):
    ...
    try:
        ...
        # Look for various possible selectors - try dynamic numbers too
        selectors_to_try = [
            "//div[contains(@class, 'v-badge') and contains(., '849')]",
            "//div[contains(@class, 'v-badge')]//span[contains(text(), '849')]/..",
            "//div[contains(@class, 'v-badge')]//span[text()='849']/../..",
            "//div[contains(@class, 'v-badge')]",  # Try any badge
...
def main():
    print("🚀 Gancio Duplicate Event Remover - Final Version")
    print("=" * 50)
