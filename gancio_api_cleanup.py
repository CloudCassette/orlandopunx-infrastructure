...
def main():
    ...
    test_deleted, test_failed, _ = delete_duplicates(BASE_URL, test_batch, token, batch_size=3)
    ...
    if len(duplicates) > 3:
        ...
        # Delete the rest
        deleted, failed, failed_ids = delete_duplicates(BASE_URL, remaining, token, batch_size=20)
